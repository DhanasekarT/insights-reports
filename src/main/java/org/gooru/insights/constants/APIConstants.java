...
public interface APIConstants {
	...
	String XAPI_SUPPORTED_EVENTS = "item.create|item.edit|item.delete|profile.action|item.flag|item.rate|reaction.create|item.review|comment.create|resource.play|collection.play|collection.resource.play|library.view|item.load|classpage.view|user.login|user.logout";
