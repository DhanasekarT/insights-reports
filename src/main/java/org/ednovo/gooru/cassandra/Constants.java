...
public interface Constants {
	...
	public String STOREAWSDO= "AWS~DO";
	
	public String STOREAWS = "AWS";
	
	public String STOREDO = "DO";
	
	public String JUNITKEY = "junit_test";
	
	public String JUNITENDPOINTCOLUMN = "api_end_point";
	
	public String JUNITPATHCOLUMN = "api_path";
	
	public String JUNITTOKENCOLUMN = "session_token";
	
	public String JUNITQUERYIDSCOLUMN = "api_query_uid";
	
	public String JUNITQUERYCOLUMN = "query";
}
